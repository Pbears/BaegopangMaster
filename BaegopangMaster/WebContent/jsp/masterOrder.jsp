...
%>
		...
		<div id="searchContainer">
				<table align="center">
					<tr>
						...
						<td>
							<input type="button" id="searchBtn" value="Refresh" class="btn btn-default">
						</td>
						<td>
				...
				<tr>
					<td colspan="7">
						<div id="collapse<%=i%>" class="panel-collapse collapse">
							<ul class="list-group">
								<li class="list-group-item">메뉴 : <%=bean.getMenuname() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 수량 : <%=bean.getAmount() %></li>
							</ul>
						</div>
					</td>
				<td></td>	
   ...
   <div class="paging" style="text-align: center;">
      <ul class="pagination">
         <ul class="pager">
            <li>
            <a href="masterOrder.jsp?page=1" aria-label="Previous">
         ...
         %>
               <a href="masterOrder.jsp?page=<%=startPage - 1%>&query=<%=query%>&data=<%=data%>">
                  Previous
               </a>
         <%
               }else{
         ...
         <% 
               ...
               if (currentPage != startPage) {
         %>
                  <a href="masterOrder.jsp?page=<%=currentPage - 1%>&query=<%=query%>&data=<%=data%>">
                     Previous
                  </a>
         <%
               }else{
      ...
      <span> 
         <%
          ...
          %> 
                <li>
                   <a href="masterOrder.jsp?page=<%=i%>&query=<%=query%>&data=<%=data%>">
                      <%=i %>
                  </a>
               </li>
         <%
      ...
      <li>
         <a href="masterOrder.jsp?page=<%=totalPage%>&query=<%=query%>&data=<%=data%>" aria-label="Next">
