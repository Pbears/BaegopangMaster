...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div class="bot_contents">
		<div id="notice">
			<p style="display: inline-block; margin-bottom: 40px;">공지사항</p>
			<a href="#" style="padding: 0px;">
				<p style="display: inline-block; margin-left: 270px; font-size: 20px; color: #646464;">더보기</p>
			</a>
			<div id="notice_list">
				<ui>
					<li>회원가입 시 주의사항</li>
		...
		<div id="service">
			<p>입점 안내</p>
			<p style="font-size: 25px; color: #646464; margin: 0;">음식점 성장 파트너, 배고팡</p>
